...
export default {
  ...
  computed: {
    ...
    isShowedLocationForm: {
      ...
      set(value) {
        const getIsShowedLocation = this.$store.getters.getIsShowedLocation
        const epale = getIsShowedLocation && value
        if (epale) {
          return
        } else {
          // console.log('set', { value, getIsShowedLocation: this.$store.getters.getIsShowedLocation }, 'isShowedLocationForm')
          // this.$store.commit('setShowedLocation', value)
          return value
        }
      }
    },
